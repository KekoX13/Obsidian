...
### [Receiving User Input](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#receiving-user-input)
...
As mentioned earlier, `read_line` puts whatever the user enters into the string we pass to it, but it also returns a value—in this case, an [`io::Result`](https://doc.rust-lang.org/std/io/type.Result.html). Rust has a number of types named `Result` in its standard library: a generic [`Result`](https://doc.rust-lang.org/std/result/enum.Result.html) as well as specific versions for submodules, such as `io::Result`. The `Result` types are [_enumerations_](https://doc.rust-lang.org/book/ch06-00-enums.html), often referred to as _enums_, which can have a fixed set of possibilities known as _variants_. Enums are often used with `match`, a conditional that makes it convenient to execute different code based on which variant an enum value is when the conditional is evaluated.
...
The right way to suppress the warning is to actually write error handling, but in our case we just want to crash this program when a problem occurs, so we can use `expect`. You’ll learn about recovering from errors in [Chapter 9](https://doc.rust-lang.org/book/ch09-02-recoverable-errors-with-result.html).

### [Printing Values with `println!` Placeholders](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#printing-values-with-println-placeholders)
...
### [Testing the First Part](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#testing-the-first-part)
...
## [Allowing Multiple Guesses with Looping](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#allowing-multiple-guesses-with-looping)
...
### [Quitting After a Correct Guess](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#quitting-after-a-correct-guess)
...
## [Summary](https://doc.rust-lang.org/book/ch02-00-guessing-game-tutorial.html#summary)
...
[](https://doc.rust-lang.org/book/ch01-03-hello-cargo.html "Previous chapter")[](https://doc.rust-lang.org/book/ch03-00-common-programming-concepts.html "Next chapter")